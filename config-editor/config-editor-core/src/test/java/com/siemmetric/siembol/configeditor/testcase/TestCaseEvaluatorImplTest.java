package com.siemmetric.siembol.configeditor.testcase;
...
import com.siemmetric.siembol.configeditor.model.ConfigEditorTestCaseResult;
...
public class TestCaseEvaluatorImplTest {
    ...
    private final String simpleTestCaseMissing = """
             {
               "test_case_name": "test",
               "version": 1,
               "author": "john",
    ...
    public void setUp() throws Exception {
        testCaseEvaluator = new TestCaseEvaluatorImpl(new ConfigEditorUiLayout());
    }
    ...
    public void invalidUiConfigLayout() throws Exception {
        ...
        uiLayout.getTestCaseLayout().put("unknown", JsonNodeFactory.instance.objectNode());
